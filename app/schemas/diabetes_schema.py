...
class DiabetesInput(BaseModel):
    ...
    BloodPressure: int = Field(
        ...
        le=200,
        example=70,
        description="Diastolic blood pressure (mm Hg, 0-200)",
    )
    SkinThickness: int = Field(
        ...
        le=100,
        example=20,
        description="Triceps skinfold thickness (mm, 0-100)",
    )
    Insulin: int = Field(
        ...,
        ge=0,
        le=900,
        example=85,
        description="2-Hour serum insulin (mu U/ml, 0-900)",
    )
    BMI: float = Field(
        ..., ge=0.0, le=80.0, example=28.5, description="Body mass index (0-80)"
    )
    DiabetesPedigreeFunction: float = Field(
        ...
        le=3.0,
        example=0.45,
        description="Diabetes pedigree function (0-3)",
    )
